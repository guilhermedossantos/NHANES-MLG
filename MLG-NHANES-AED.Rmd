...
```{r}
demo <- read.xport("D:\\Users\\guisa\\Downloads\\DEMO_I.XPT")
renda <- read.xport("D:\\Users\\guisa\\Downloads\\INQ_I.XPT")
atvfisica <- read.xport("D:\\Users\\guisa\\Downloads\\PAQ_I.XPT")
diabetes <- read.xport("D:\\Users\\guisa\\Downloads\\DIQ_I.XPT")
cigarro <- read.xport("D:\\Users\\guisa\\Downloads\\SMQRTU_I.XPT")
```
