...
alcool <- read.xport("NHANES\\ALQ_I.XPT")
drogas <- read.xport("NHANES\\DUQ_I.XPT")
sono <- read.xport("NHANES\\SLQ_I.XPT")
peso <- read.xport("NHANES\\WHQ_I.XPT")
```
...
table(classificacao2, dados$diabetes) 
```
